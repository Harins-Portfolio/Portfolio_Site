    ...
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-100 rounded-full mb-8">
          ...
          <span className="text-blue-700 text-sm font-medium">Ready to get started?</span>
        </div>

        <h2 className="text-4xl md:text-6xl font-black text-[#0F172A] leading-[1.1] mb-6">
          Stop Guessing.<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-600">Start Analyzing.</span>
        </h2>

        <p className="text-lg text-gray-500 max-w-xl mx-auto mb-10 leading-relaxed">
          Your data holds the answers. Submit a project request today and get a professional analytics solution tailored to your business.
        </p>
        ...
        <div className="mt-16 pt-16 border-t border-gray-100">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm font-bold text-[#0F172A]">Revision Included</p>
